...
class AppSpacing {
  ...
  static const EdgeInsets hMD_vXXS  = EdgeInsets.symmetric(horizontal: md,  vertical: xxs);
  static const EdgeInsets hMD_vXS   = EdgeInsets.symmetric(horizontal: md,  vertical: xs);
  static const EdgeInsets hMD_vSM   = EdgeInsets.symmetric(horizontal: md,  vertical: sm);
  static const EdgeInsets hXL_vMD   = EdgeInsets.symmetric(horizontal: xl,  vertical: md);
  static const EdgeInsets hXL_vXXL  = EdgeInsets.symmetric(horizontal: xl,  vertical: xxl);
}
